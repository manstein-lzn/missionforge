...
async function main(argv) {
    ...
    try {
        ...
        if (input) {
            await writeJsonFile(resolveWorkspaceRef(workspaceRoot, input.output_ref), {
                ...
                changed_refs: [
                    ...
                    input.context_observations_ref,
                    input.context_projection_ref,
                ],
                commands_run: [],
                tests_run: [],
                failures: [message],
                ...
                context_projection_ref: input.context_projection_ref,
                duration_ms: 0,
                metrics: {},
            }, { workspaceRoot });
        }
...
function relativeBackToRoot(inputRef) {
