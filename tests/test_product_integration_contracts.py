...
class ProductIntegrationContractTests(unittest.TestCase):
    def test_task_contract_compile_result_round_trip(self) -> None:
        result = ProductTaskContractCompileResult(
            product_id="product",
            status=ProductCompileStatus.COMPILED,
            intent_bundle_ref="inputs/intent_bundle.json",
            ...
            hard_check_refs=["runs/product/reports/hard_checks.json"],
    ...
    def test_clarification_request_fields_are_refs_only(self) -> None:
        result = ProductTaskContractCompileResult(
            product_id="product",
            status=ProductCompileStatus.NEEDS_CLARIFICATION,
            intent_bundle_ref="inputs/intent_bundle.json",
            ...
            clarification_questions=[
                ProductClarificationQuestion(
                    ...
                    source_refs=["inputs/intent_bundle.json"],
                )
            ],
        )
